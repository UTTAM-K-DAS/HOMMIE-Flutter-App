...
class RichHomeScreen extends StatelessWidget {
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    _buildHorizontalServiceList(context, [
                    ...
                    _buildSectionHeader(context, 'For Your Home', () {
                      Navigator.pushNamed(context, '/view-all', arguments: {
                        'category': 'home',
                        'title': 'For Your Home'
                      });
  ...
  Widget _buildServiceGrid(BuildContext context, List<ServiceItem> services) {
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        ...
        crossAxisSpacing: 12,
        mainAxisSpacing: 12,
        childAspectRatio: 1.3, // Wider ratio to prevent overflow
      ),
      itemCount: services.length,
      itemBuilder: (context, index) {
        final service = services[index];
        return _buildSimpleServiceCard(context, service);
      },
    );
  }

  Widget _buildHorizontalServiceList(
      BuildContext context, List<ServiceItem> services) {
    return SizedBox(
      height: 140,
  ...
  Widget _buildSimpleServiceCard(BuildContext context, ServiceItem service) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
