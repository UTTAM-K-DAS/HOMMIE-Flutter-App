...
import 'date_time_screen.dart' show DateTimeScreen;
                  ...
                  MaterialPageRoute(
                    builder: (context) => DateTimeScreen(
                      selectedService: ServiceModel(
                        ...
                        imageUrl:
                            'https://img.icons8.com/color/2x/cleaning.png',
                        price: 0.0, // This will be calculated based on rooms
                        category: 'Cleaning',
                        duration: 60, // Base duration in minutes
                        extras: {
                          'rooms': _selectedRooms
                              .map((index) => _rooms[index][0])
                              .toList(),
                          'roomCounts': _selectedRooms
                              .map((index) => _rooms[index][3])
                              .toList(),
                        },
                      ),
                    ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: _selectedRooms.contains(index)
              ? (room[2] as MaterialColor).shade50.withAlpha(50)
              ...
              children: [
                ...
                _selectedRooms.contains(index)
                    ? Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.greenAccent.shade100.withAlpha(0),
                          borderRadius: BorderRadius.circular(10.0),
                        ),
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: room[3] == index + 1
                                        ? (room[2] as MaterialColor).withAlpha(
                                            50,
                                          )
                                        : (room[2] as MaterialColor)
                                            .shade200
                                            .withAlpha(50),
                                  ),
                                  child: Center(
